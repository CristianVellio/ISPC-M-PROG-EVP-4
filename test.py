...
#uso bateria
    ...
    def test_abrir_app_con_bateria_insuficiente(self):
        self.mi_smartphone.bateria = 10
        self.mi_smartphone.abrir_app(20)
        self.assertEqual(self.mi_smartphone.bateria, 10)
        self.assertEqual(self.mi_smartphone.apps_abiertas, 0)
...
#almacenamiento
    ...
    def test_instalar_app_con_espacio_disponible(self):
        ...
        self.assertEqual(self.mi_smartphone.almacenamiento_usado, 30)

    def test_instalar_app_sin_espacio_disponible(self):
        self.mi_smartphone.almacenamiento_usado = 100
        self.mi_smartphone.instalar_app(30)
        self.assertEqual(self.mi_smartphone.almacenamiento_usado, 100)

#testing

    def test_str_method(self):
        resultado = str(self.mi_smartphone)
        self.assertEqual(resultado, "Smartphone Voltron X con 100% de bateria y 28 GB de almacenamiento libre")
